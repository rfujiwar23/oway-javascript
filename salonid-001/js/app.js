...
var vm = new Vue({
  ...
  data: {
    products: [
      // life-style
      { id: 4, productNameJP: 'テルソ（240ml）', productNameENG: 'terso（240ml）', imageSource: '../../../image/dog/lifestyle007-terso.png', ifingUrl: 'https://ifing-beauty.com/products/detail/318salon_id=5' },
      { id: 2, productNameJP: 'ネブラ（50ml）', productNameENG: 'nebula（50ml）', imageSource: '../../../image/dog/lifestyle005-nebula.png', ifingUrl: 'https://ifing-beauty.com/products/detail/317salon_id=5' },
      { id: 1, productNameJP: 'ルジャータ（50ml）', productNameENG: 'rugiata（50ml）', imageSource: '../../../image/dog/lifestyle004-rugiada.png', ifingUrl: 'https://ifing-beauty.com/products/detail/316salon_id=5' },
      { id: 3, productNameJP: 'ブルーマ（100ml）', productNameENG: 'bruma（100ml）', imageSource: '../../../image/dog/lifestyle006-bruma.png', ifingUrl: 'https://ifing-beauty.com/products/detail/315salon_id=5' },
...
var vm = new Vue({
  ...
  data: {
    products: [
      ...
      { id: 5, productNameJP: 'プロディジャスバーム（25ml）', productNameENG: 'Prodigious Balm 25ml', imageSource: '../../../image/dog/lifestyle008-prodigious-balm.png', ifingUrl: 'https://ifing-beauty.com/products/detail/319salon_id=5' },
...
var vm = new Vue({
  ...
  data: {
    products: [
      { id: 6, productNameJP: 'レメディ ハンドバーム 50ml', productNameENG: 'Remedy Hand Balm 50ml', imageSource: '../../../image/dog/lifestyle003-remedy-hand-balm.png', ifingUrl: 'https://ifing-beauty.com/products/detail/306salon_id=5' },
      { id: 7, productNameJP: 'ヴェルート (リップクリーム) 10ml', productNameENG: 'Velluto (Lip Cream) 10ml', imageSource: '../../../image/dog/lifestyle002-Velluto.png', ifingUrl: 'https://ifing-beauty.com/products/detail/307salon_id=5' },
      { id: 9, productNameJP: 'テロ', productNameENG: 'Telo', imageSource: '../../../image/dog/lifestyle001-telo.png', ifingUrl: 'https://ifing-beauty.com/products/detail/308salon_id=5' },
    ]
  }
});
...
var vm = new Vue({
  ...
  data: {
    products: [
      // dog
      { id: 8, productNameJP: 'デュエット 240ml', productNameENG: 'Duetto 240ml', imageSource: '../../../image/dog/Duetto-01.jpg', ifingUrl: 'https://ifing-beauty.com/products/detail/212salon_id=5' },
    ]
  }
});
